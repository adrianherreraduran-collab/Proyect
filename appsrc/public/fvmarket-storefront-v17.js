// FVM_STOREFRONT_V18 · carousel optimizado para nitidez desktop + categorías fuera del banner
(()=>{
  const slides=[
    {src:'/assets/fvmarket/hero-1.webp?v=18',cat:'Jardín',alt:'FVMarket · Jardín y exterior'},
    {src:'/assets/fvmarket/hero-2.webp?v=18',cat:'Herramientas',alt:'FVMarket · Bricolaje y herramientas'},
    {src:'/assets/fvmarket/hero-3.webp?v=18',cat:'',alt:'FVMarket · Ventanas y accesorios'},
    {src:'/assets/fvmarket/hero-4.webp?v=18',cat:'Baño y cocina',alt:'FVMarket · Baño, sanitarios y fontanería'},
    {src:'/assets/fvmarket/hero-5.webp?v=18',cat:'Electricidad',alt:'FVMarket · Electricidad e iluminación'},
    {src:'/assets/fvmarket/hero-6.webp?v=18',cat:'',alt:'FVMarket · Todo para tu proyecto'}
  ];
  const css=document.createElement('style');css.id='fvmStoreV18Style';css.textContent=`
    .v5hero,body .v5cats{display:none!important}
    .v17Hero{position:relative;width:100%;background:#052e59;overflow:hidden}
    .v17Track{position:relative;width:100%;max-width:1536px;margin:0 auto;aspect-ratio:2.24/1;overflow:hidden;background:#052e59}
    .v17Slide{position:absolute;inset:0;opacity:0;transition:opacity .65s ease;pointer-events:none;background:#052e59;overflow:hidden}
    .v17Slide.active{opacity:1;pointer-events:auto}
    .v17Slide img{position:absolute;left:0;top:0;width:100%;height:auto;min-height:100%;display:block;object-fit:cover;object-position:center top;image-rendering:auto;-webkit-font-smoothing:antialiased;backface-visibility:hidden;transform:translateZ(0)}
    .v17HeroBtn{position:absolute;top:50%;transform:translateY(-50%);z-index:4;width:42px;height:42px;border:0;border-radius:50%;background:#052e59d9;color:#fff;font-size:25px;cursor:pointer;box-shadow:0 5px 20px #0004}.v17HeroBtn:hover{background:#f28a00}.v17Prev{left:max(18px,calc((100vw - 1536px)/2 + 18px))}.v17Next{right:max(18px,calc((100vw - 1536px)/2 + 18px))}.v17Dots{position:absolute;z-index:5;left:50%;bottom:13px;transform:translateX(-50%);display:flex;gap:7px;background:#052e598c;padding:6px 9px;border-radius:999px}.v17Dot{width:8px;height:8px;border-radius:50%;border:0;background:#fff8;cursor:pointer;padding:0}.v17Dot.active{background:#f28a00;transform:scale(1.25)}
    ...
    @media(max-width:800px){.v17Track{max-width:none;min-height:210px;aspect-ratio:2/1}.v17Slide img{width:100%;height:100%;min-height:0;object-fit:cover;object-position:center}.v17HeroBtn{width:34px;height:34px;font-size:19px}.v17Prev{left:8px}.v17Next{right:8px}.v17Dots{bottom:7px}}
