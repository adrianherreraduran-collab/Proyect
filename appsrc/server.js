...
function fvmarketOrigin(d){
  const s=d.settings||{};
  return String(s.rutaFVOrigin||[s.fiscalAddress,s.fiscalPostalCode,s.fiscalCity].filter(Boolean).join(', ')||FVMARKET_FISCAL_ORIGIN||'').trim();
}
